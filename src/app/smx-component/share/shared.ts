...
@NgModule({
  ...
  exports: [SmxHeader, SmxFooter, Column, PrimeTemplate, Row, HeaderColumnGroup, FooterColumnGroup],
  declarations: [SmxHeader, SmxFooter, Column, PrimeTemplate, Row, HeaderColumnGroup, FooterColumnGroup]
})
