...
import {SharedModule, PrimeTemplate, SmxFooter, SmxHeader} from '../share/shared';
import {DomHandler} from '../share/domhandler';
import {ObjectUtils} from '../share/objectutils';
import {NG_VALUE_ACCESSOR, ControlValueAccessor} from '@angular/forms';

export const LISTBOX_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => SmxListboxComponent),
  multi: true
};

@Component({
  selector: 'smx-listbox',
  template: `
    <div
      [ngClass]="{'ui-listbox ui-inputtext ui-widget ui-widget-content ui-corner-all':true,'ui-state-disabled':disabled,'ui-state-focus':focus}"
      ...
      <div class="ui-widget-header ui-corner-all ui-listbox-header ui-helper-clearfix"
           *ngIf="(checkbox && multiple && showToggleAll) || filter"
           [ngClass]="{'ui-listbox-header-w-checkbox': checkbox}">
        <div class="ui-chkbox ui-widget" *ngIf="checkbox && multiple && showToggleAll">
          <div class="ui-helper-hidden-accessible">
            <input type="checkbox" readonly="readonly" [checked]="allChecked" (focus)="onHeaderCheckboxFocus()"
                   (blur)="onHeaderCheckboxBlur()" (keydown.space)="toggleAll($event)">
          </div>
          <div #headerchkbox class="ui-chkbox-box ui-widget ui-corner-all ui-state-default"
        ...
        <div class="ui-listbox-filter-container" *ngIf="filter">
          <input type="text" role="textbox" [value]="filterValue||''" (input)="onFilter($event)"
      ...
      <div class="ui-listbox-list-wrapper" [ngStyle]="listStyle">
        <ul class="ui-listbox-list">
          <li *ngFor="let option of options; let i = index;" [style.display]="isItemVisible(option) ? 'block' : 'none'"
              ...
              (click)="onOptionClick($event,option)" (dblclick)="onOptionDoubleClick($event,option)"
              (touchend)="onOptionTouchEnd($event,option)" (keydown)="onOptionKeyDown($event,option)">
...
export class SmxListboxComponent implements AfterContentInit, ControlValueAccessor {
  ...
  @ContentChild(SmxHeader, {static: false}) headerFacet;

  @ContentChild(SmxFooter, {static: false}) footerFacet;
...
@NgModule({
  ...
  exports: [SmxListboxComponent, SharedModule],
  declarations: [SmxListboxComponent]
})
export class SmxListboxModule {
}
