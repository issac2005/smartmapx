...
import { SmxMessageConfig } from './smx-message-config';
import { SmxMessageContainerComponent } from './smx-message-container.component';
import { NzMessageData, NzMessageDataFilled, NzMessageDataOptions } from './smx-message.definitions';

let globalCounter = 0;

export class NzMessageBaseService<
  ContainerClass extends SmxMessageContainerComponent,
  MessageData,
  MessageConfig extends SmxMessageConfig
> {
...
export class SmxMessageService extends NzMessageBaseService<
  SmxMessageContainerComponent,
  NzMessageData,
  SmxMessageConfig
> {
  constructor(overlay: Overlay, injector: Injector, cfr: ComponentFactoryResolver, appRef: ApplicationRef) {
    super(overlay, SmxMessageContainerComponent, injector, cfr, appRef, 'message-');
  }
