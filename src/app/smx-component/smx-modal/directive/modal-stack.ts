...
import {ContentRef} from '../utils/popup';
import {ScrollBar} from '../utils/scrollbar';
import {isDefined, isString} from '../utils/util';
import {NgbModalBackdrop} from './modal-backdrop';
import {SmxActiveModal, NgbModalRef} from './modal-ref';
...
export class NgbModalStack {
  ...
  private _windowAttributes = ['ariaLabelledBy', 'backdrop', 'centered', 'keyboard', 'size', 'windowClass', 'newModal', 'enterKeyId'];
  ...
  open(moduleCFR: ComponentFactoryResolver, contentInjector: Injector, content: any, options): NgbModalRef {
    ...
    const activeModal = new SmxActiveModal();
  ...
  private _getContentRef(
      ...
      activeModal: SmxActiveModal): ContentRef {
    if (!content) {
  ...
  private _createFromTemplateRef(content: TemplateRef<any>, activeModal: SmxActiveModal): ContentRef {
    const context = {
  ...
  private _createFromComponent(
      moduleCFR: ComponentFactoryResolver, contentInjector: Injector, content: any,
      context: SmxActiveModal): ContentRef {
    const contentCmptFactory = moduleCFR.resolveComponentFactory(content);
    const modalContentInjector =
        Injector.create({providers: [{provide: SmxActiveModal, useValue: context}], parent: contentInjector});
