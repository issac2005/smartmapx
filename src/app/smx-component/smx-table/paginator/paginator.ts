...
@Component({
  ...
  template: `
    <div [class]="styleClass" [ngStyle]="style"
      ...
      <a [attr.tabindex]="isFirstPage() ? null : '0'"
      ...
      <a tabindex="0" [attr.tabindex]="isFirstPage() ? null : '0'"
      ...
      <a [attr.tabindex]="isLastPage() ? null : '0'"
...
<!--                  (onChange)="onRppChange($event)" [appendTo]="dropdownAppendTo"-->
<!--                  [scrollHeight]="dropdownScrollHeight"></p-dropdown>-->
...
@NgModule({
  ...
  exports: [Paginator, FormsModule, SharedModule],
