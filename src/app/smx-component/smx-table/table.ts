...
import {Column, PrimeTemplate, SharedModule} from './shared';
...
export class TableService {
  ...
  private sortSource = new Subject<any | any[]>();
    ...
    <div #container [ngStyle]="style" [class]="styleClass"
      ...
      <div class="ui-table-scrollable-wrapper" *ngIf="scrollable">
        <div class="ui-table-scrollable-view ui-table-frozen-view" *ngIf="frozenColumns||frozenBodyTemplate"
             [pScrollableView]="frozenColumns" [frozen]="true" [ngStyle]="{width: frozenWidth}"
             [scrollHeight]="scrollHeight"></div>
        <div class="ui-table-scrollable-view" [pScrollableView]="columns" [frozen]="false" [scrollHeight]="scrollHeight"
...
export class SmxTableComponent implements OnInit, AfterViewInit, AfterContentInit {
  ...
  @Input() get multiSortMeta(): any[] {
    return this._multiSortMeta;
  }

  set multiSortMeta(val: any[]) {
  ...
  template: `
    <ng-container *ngIf="!dt.expandedRowTemplate">
      <ng-template ngFor let-rowData let-rowIndex="index"
                   [ngForOf]="(dt.paginator && !dt.lazy) ? ((dt.filteredValue||dt.value) | slice:dt.first:(dt.first + dt.rows)) : (dt.filteredValue||dt.value)"
                   [ngForTrackBy]="dt.rowTrackBy">
        <ng-container
          *ngTemplateOutlet="template; context: {$implicit: rowData, rowIndex: dt.paginator ? (dt.first + rowIndex) : rowIndex, columns: columns, editing: (dt.editMode === 'row' && dt.isRowEditing(rowData))}"></ng-container>
      </ng-template>
    </ng-container>
    <ng-container *ngIf="dt.expandedRowTemplate">
      <ng-template ngFor let-rowData let-rowIndex="index"
                   ...
                   [ngForTrackBy]="dt.rowTrackBy">
        <ng-container
          *ngTemplateOutlet="template; context: {$implicit: rowData, rowIndex: dt.paginator ? (dt.first + rowIndex) : rowIndex, columns: columns, expanded: dt.isRowExpanded(rowData), editing: (dt.editMode === 'row' && dt.isRowEditing(rowData))}"></ng-container>
        <ng-container *ngIf="dt.isRowExpanded(rowData)">
          <ng-container
            *ngTemplateOutlet="dt.expandedRowTemplate; context: {$implicit: rowData, rowIndex: dt.paginator ? (dt.first + rowIndex) : rowIndex, columns: columns}"></ng-container>
        </ng-container>
      </ng-template>
    </ng-container>
...
export class TableBody {
  ...
  constructor(public dt: SmxTableComponent) {
  }
}
  ...
  template: `
    ...
    <div #scrollBody class="ui-table-scrollable-body">
      <table #scrollTable
             ...
             [class]="dt.tableStyleClass" [ngStyle]="dt.tableStyle">
        <ng-container
          *ngTemplateOutlet="frozen ? dt.frozenColGroupTemplate||dt.colGroupTemplate : dt.colGroupTemplate; context {$implicit: columns}"></ng-container>
        <tbody class="ui-table-tbody" [pTableBody]="columns"
               [pTableBodyTemplate]="frozen ? dt.frozenBodyTemplate||dt.bodyTemplate : dt.bodyTemplate"></tbody>
      </table>
      <table #loadingTable *ngIf="dt.virtualScroll && dt.loadingBodyTemplate != null"
             [ngClass]="{'ui-table-scrollable-body-table ui-table-loading-virtual-table': true, 'ui-table-virtual-table': dt.virtualScroll}">
        <tbody class="ui-table-tbody">
...
export class ScrollableView implements AfterViewInit, OnDestroy, AfterViewChecked {
  ...
  constructor(public dt: SmxTableComponent, public el: ElementRef, public zone: NgZone) {
...
export class SelectableRow implements OnInit, OnDestroy {
  ...
  constructor(public dt: SmxTableComponent, public tableService: TableService) {
    if (this.isEnabled()) {
...
export class InitEditableRow {
  ...
  constructor(public dt: SmxTableComponent, public editableRow: EditableRow) {
  }
...
export class CellEditor implements AfterContentInit {
  ...
  constructor(public dt: SmxTableComponent, @Optional() public editableColumn: EditableColumn, @Optional() public editableRow: EditableRow) {
  }
...
@NgModule({
  ...
  exports: [SmxTableComponent, SharedModule, SortableColumn, SelectableRow, RowToggler, ContextMenuRow, ResizableColumn, ReorderableColumn, EditableColumn, CellEditor, SortIcon, TableRadioButton, TableCheckbox, TableHeaderCheckbox, ReorderableRowHandle, ReorderableRow, SelectableRowDblClick, EditableRow, InitEditableRow, SaveEditableRow, CancelEditableRow],
  declarations: [SmxTableComponent, SortableColumn, SelectableRow, RowToggler, ContextMenuRow, ResizableColumn, ReorderableColumn, EditableColumn, CellEditor, TableBody, ScrollableView, SortIcon, TableRadioButton, TableCheckbox, TableHeaderCheckbox, ReorderableRowHandle, ReorderableRow, SelectableRowDblClick, EditableRow, InitEditableRow, SaveEditableRow, CancelEditableRow]
})
export class SmxTableModule {
}
